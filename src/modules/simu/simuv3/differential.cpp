...
SimDifferentialConfig(void *hdle, const char *section, tDifferential *differential)
{
    ...
    differential->I		= GfParmGetNum(hdle, section, PRM_INERTIA, (char*)nullptr, 0.1);
    differential->efficiency	= GfParmGetNum(hdle, section, PRM_EFFICIENCY, (char*)nullptr, 1.0);
    differential->ratio		= GfParmGetNum(hdle, section, PRM_RATIO, (char*)nullptr, 1.0);
    differential->bias		= GfParmGetNum(hdle, section, PRM_BIAS, (char*)nullptr, 0.1);
    differential->dTqMin	= GfParmGetNum(hdle, section, PRM_MIN_TQ_BIAS, (char*)nullptr, 0.05);
    differential->dTqMax	= GfParmGetNum(hdle, section, PRM_MAX_TQ_BIAS, (char*)nullptr, 0.80) - differential->dTqMin;
    differential->dSlipMax	= GfParmGetNum(hdle, section, PRM_MAX_SLIP_BIAS, (char*)nullptr, 0.75);
    differential->lockInputTq	= GfParmGetNum(hdle, section, PRM_LOCKING_TQ, (char*)nullptr, 300.0);
    differential->viscosity	= GfParmGetNum(hdle, section, PRM_VISCOSITY_FACTOR, (char*)nullptr, 2.0);
