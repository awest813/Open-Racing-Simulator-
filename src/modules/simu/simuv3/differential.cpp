...
SimDifferentialConfig(void *hdle, const char *section, tDifferential *differential)
{
    ...
    differential->I		= GfParmGetNum(hdle, section, PRM_INERTIA, nullptr, 0.1);
    differential->efficiency	= GfParmGetNum(hdle, section, PRM_EFFICIENCY, nullptr, 1.0);
    differential->ratio		= GfParmGetNum(hdle, section, PRM_RATIO, nullptr, 1.0);
    differential->bias		= GfParmGetNum(hdle, section, PRM_BIAS, nullptr, 0.1);
    differential->dTqMin	= GfParmGetNum(hdle, section, PRM_MIN_TQ_BIAS, nullptr, 0.05);
    differential->dTqMax	= GfParmGetNum(hdle, section, PRM_MAX_TQ_BIAS, nullptr, 0.80) - differential->dTqMin;
    differential->dSlipMax	= GfParmGetNum(hdle, section, PRM_MAX_SLIP_BIAS, nullptr, 0.75);
    differential->lockInputTq	= GfParmGetNum(hdle, section, PRM_LOCKING_TQ, nullptr, 300.0);
    differential->viscosity	= GfParmGetNum(hdle, section, PRM_VISCOSITY_FACTOR, nullptr, 2.0);
