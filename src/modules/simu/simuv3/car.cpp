...
SimCarConfig(tCar *car)
{
    ...
    car->dimension.x = GfParmGetNum(hdle, SECT_CAR, PRM_LEN, (char*)nullptr, 4.7);
    car->dimension.y = GfParmGetNum(hdle, SECT_CAR, PRM_WIDTH, (char*)nullptr, 1.9);
    overallwidth     = GfParmGetNum(hdle, SECT_CAR, PRM_OVERALLWIDTH, (char*)nullptr, car->dimension.y);
    car->dimension.z = GfParmGetNum(hdle, SECT_CAR, PRM_HEIGHT, (char*)nullptr, 1.2);
