...
SimEngineConfig(tCar *car)
{
	...
	car->engine.I           = GfParmGetNum(hdle, SECT_ENGINE, PRM_INERTIA, nullptr, 0.2423f);
	car->engine.fuelcons    = GfParmGetNum(hdle, SECT_ENGINE, PRM_FUELCONS, nullptr, 0.0622f);
	car->engine.brakeCoeff  = GfParmGetNum(hdle, SECT_ENGINE, PRM_ENGBRKCOEFF, nullptr, 0.33f);
