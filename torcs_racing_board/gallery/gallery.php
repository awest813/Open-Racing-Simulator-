...
*/
	...
	$page->set_var(array(
		'PC_LIST_NEXT_LINK'		=> ($more_rows === TRUE) ? htmlspecialchars($_SERVER['PHP_SELF'] . '?listfrom=' . ($listfrom+$LST), ENT_QUOTES, 'UTF-8'): '',
		'PC_LIST_NEXT'			=> ($more_rows === TRUE) ? 'Next' : '',
		'PC_LIST_PREV_LINK'		=> ($listfrom > 0) ? htmlspecialchars($_SERVER['PHP_SELF'] . '?listfrom=' . max($listfrom-$LST, 0), ENT_QUOTES, 'UTF-8'): '',
