...
*/
	...
	// Set up page header.
	$page->set_var(array(
		'PB_PAGETITLE'		=> 'Open Racing Simulator — Racing Board Result Submission Confirm Page',
		'PB_DESCRIPTION'	=> 'Could not run the race for an event on the Open Racing Simulator racing board',
