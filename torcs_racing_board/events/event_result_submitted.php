...
*/
	...
	// Set up page header.
	$page->set_var(array(
		'PB_PAGETITLE'		=> 'Open Racing Simulator — Racing Board Result Submission Page',
		'PB_DESCRIPTION'	=> 'Submit the results for an event on the Open Racing Simulator racing board',
