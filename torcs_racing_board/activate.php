...
*/
	...
	require_once($path_to_root . 'lib/functions_activate.php');
	...
	// Cleanup outdated pending accounts.
	cleanupPending($user_tablename, $confirm_tablename);

	// Try to activate account.
	if (activateAccount($user_tablename, $confirm_tablename) == TRUE) {
		$page_content = 'activate_content_pass.ihtml';
	} else {
		$page_content = 'activate_content_fail.ihtml';
	}
